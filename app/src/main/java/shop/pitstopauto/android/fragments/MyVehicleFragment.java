...
public class MyVehicleFragment extends Fragment {
    ...
    ExtendedFloatingActionButton fab_add_vehicle;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        root = inflater.inflate(R.layout.fragment_my_vehicle, container, false);
        unbinder = ButterKnife.bind(this, root);

        loggedInUser = (User) Stash.getObject(Constants.LOGGED_IN_USER, User.class);

        mycarArrayList = new ArrayList<>();
        mAdapter = new MyCarAdapter(context, mycarArrayList);
        ...
        fab_add_vehicle.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                NavHostFragment.findNavController(MyVehicleFragment.this).navigate(R.id.nav_add_car);
...
//                        Log.e(TAG, String.valueOf(error.getErrorCode()));
                        ...
                        if (error.getErrorCode() == 0){
                            ...
                            Snackbar.make(root.findViewById(R.id.frag_my_vehicle), "Error: " + error.getErrorBody(), Snackbar.LENGTH_LONG).show();
