...
import shop.pitstopauto.android.adapters.CarHomeAdapter;
...
public class HomeFragment extends Fragment {
    ...
    private CarHomeAdapter mAdapter;
    ...
    @BindView(R.id.no_vehicle_lyt)
    LinearLayout no_vehicle_lyt;

    @BindView(R.id.error_lyt)
    LinearLayout error_lyt;

    @BindView(R.id.myVehicleLayout)
    CardView myVehicleLayout;

    @BindView(R.id.diagnosticsLayout)
    CardView diagnosticsLayout;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAdapter = new CarHomeAdapter(context, mycarArrayList);
        ...
        myVehicleLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                NavHostFragment.findNavController(HomeFragment.this).navigate(R.id.nav_menu_my_vehicle);

            }
        });

        diagnosticsLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                NavHostFragment.findNavController(HomeFragment.this).navigate(R.id.nav_menu_diagnostics);
