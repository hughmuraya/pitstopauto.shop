package shop.pitstopauto.android.dependancies;
...
public class Constants {
    ...
    public static String MY_CAR = "data/get/car/";
    public static String CAR_MAKE = "data/all/cars/";
    public static String CAR_MODEL = "data/car/models";
    public static String CAR_YEAR = "data/car/years";
